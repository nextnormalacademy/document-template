...
.. `:curriculum-short: MODULKUERZEL`: this is the abbreviation of your module. Replace MODULKUERZEL with your module name e.g. APO
...
. Open README.adoc and replace the string `curriculum-template` with the name of your Github repository e.g. `apo-curriculum`
